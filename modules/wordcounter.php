                ...
                <div class="row">
                    <div class="card-style mb-50">
                        ...
                        <style type="text/css">
                            ...
                            .output.row span{font-weight:bold;font-size:1.5rem}
                            #readability{width:52%;font-weight:bold}
                            #readability:hover{background-color:#4D90FE;color:#FFF;border-radius:2px;cursor:pointer}
                            #readability:active{background-color:#307AF3}
                            .keywords{display:none;margin:4% 0 0;font-size:2rem;font-weight:900}
                            .keywords ul{font-weight:400;border:1px solid #DDD;font-size:1.4rem;background-color:#F9F9F9;margin:2% 0}
                            .keywords li{display:inline-block;width:44%;padding:10px;margin:1%}
                            @media (max-width:750px){body{width:600px}.output.row{font-size:1.2rem}.output.row span{font-size:1.3rem}.keywords ul{font-size:1.2rem}}
                            @media (max-width:600px){body{width:100%}.output.row{border:none;background-color:#FFF}.output.row div{display:block;width:100%;padding:10px 15px;margin:2% auto;border:1px solid #DDD;font-size:1.8rem;background-color:#F9F9F9}.output.row span{font-size:2rem}#readability{width:100%;font-size:1.6rem;font-weight:400}.keywords{margin:10% auto}.keywords ul{font-weight:400;border:none;font-size:1.8rem;background-color:#F9F9F9;margin:5% 0}.keywords li{display:block;width:100%;padding:10px;margin:2% auto;border:1px solid #DDD}}
                        </style>


                        <div class="input-style-1">
                        <textarea onclick="select()" rows="10" placeholder="Enter your text here..."></textarea>
                        </div>
